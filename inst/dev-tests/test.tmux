...
split-window R --interactive
send-keys 'largescalechunks::worker_node("localhost", 9001L, "localhost", 8999L, verbose=T)' Enter
split-window R --interactive
send-keys 'largescalechunks::worker_node("localhost", 9002L, "localhost", 8999L, verbose=T)' Enter
select-layout tiled
